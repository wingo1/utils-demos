...
public class MinimumDistance {
	...
	private static double getTheTime(double x1, double x2, double y1, double y2, double v1, double v2, double degree1,
		...
		return getTheTimeByVxVy(x1, y1, Vx1, Vy1, x2, y2, Vx2, Vy2);
	 ...
	 * @return
	 */
	private static double getTheTimeByVxVy(double x1, double y1, double Vx1, double Vy1, double x2, double y2,
	...
	private static double getTheMinimumDestance(double x1, double x2, double y1, double y2, double v1, double v2,
		...
		double Vy1 = Math.sin(degree1) * v1;
		double Vy2 = Math.sin(degree2) * v2;
		return getTheMinimumDestanceByVxVy(x1, y1, Vx1, Vy1, x2, y2, Vx2, Vy2, t);

	}

	private static double getTheMinimumDestanceByVxVy(double x1, double y1, double Vx1, double Vy1, double x2,
			double y2, double Vx2, double Vy2, double t) {
